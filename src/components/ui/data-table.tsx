            ...
            table.getRowModel().rows.map((row, index) => {
              ...
              return (
                <TableRow
                  ...
                  onClick={() =>
                    handleClickOnTable && handleClickOnTable(original)
                  }
                  className={cn(
                ...
                >
                  {row.getVisibleCells().map((cell, index) => (
                    <TableCell
                      key={cell.id}
                      className={cn("", {
                        " text-end": index === table.options.columns.length + 1,
                        "!cursor-pointer": handleClickOnTable,
                      })}
                    >
                      {index === table.options.columns.length - 1 &&
                      moreButton ? (
